...
class database {
    ...
    private $dbuser = 'jesus';
    private $dbpass = 'bueno';
    private $dbname = 'federacion';
    
    //constructor que realiza la conexion a la bbdd
    public function __construct() {
        try {
            $this->conexion = new PDO($this->driver.':host='.$this->dbhost.';dbname='.$this->dbname, $this->dbuser, $this->dbpass,array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES  \'UTF8\'')); //soluciona el problema con los acentos. codificacion utf-8 
        } catch (Exception $e) {
