...
$numNoticias = modelMain::contarNoticias('selecciones','alevines_selecciones');
...
$noticias = modelMain::noticiasPaginador('selecciones','alevines_selecciones',($pagina-1)*$numNoticiasMostrar,$numNoticiasMostrar);
