...
$numNoticias = modelMain::contarNoticias('selecciones','cadetes_selecciones');
...
$noticias = modelMain::noticiasPaginador('selecciones','cadetes_selecciones',($pagina-1)*$numNoticiasMostrar,$numNoticiasMostrar);
