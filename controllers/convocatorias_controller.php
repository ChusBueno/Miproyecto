...
$numNoticias = modelMain::contarNoticias('selecciones','convocatorias_selecciones');
...
$noticias = modelMain::noticiasPaginador('selecciones','convocatorias_selecciones',($pagina-1)*$numNoticiasMostrar,$numNoticiasMostrar);
