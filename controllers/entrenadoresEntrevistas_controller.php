...
$numNoticias = modelMain::contarNoticias('entrevistas','entrenadores_entrevistas');
...
$noticias = modelMain::noticiasPaginador('entrevistas','entrenadores_entrevistas',($pagina-1)*$numNoticiasMostrar,$numNoticiasMostrar);
