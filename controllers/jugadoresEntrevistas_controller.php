...
$numNoticias = modelMain::contarNoticias('entrevistas','jugadores_entrevistas');
...
$noticias = modelMain::noticiasPaginador('entrevistas','jugadores_entrevistas',($pagina-1)*$numNoticiasMostrar,$numNoticiasMostrar);
