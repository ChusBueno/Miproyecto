...
$numNoticias = modelMain::contarNoticias('clubes','noticias_clubes');
...
$noticias = modelMain::noticiasPaginador('clubes','noticias_clubes',($pagina-1)*$numNoticiasMostrar,$numNoticiasMostrar);
