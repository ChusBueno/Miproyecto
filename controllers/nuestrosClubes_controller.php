...
$numNoticias = modelMain::contarNoticias('clubes','nuestros_clubes');
...
$noticias = modelMain::noticiasPaginador('clubes','nuestros_clubes',($pagina-1)*$numNoticiasMostrar,$numNoticiasMostrar);
