			...
			<div id="noticias" class="col-16 col-lg-16 col-md-16 col-sm-16">
	        	...
	        	if(count($noticias)>0){
			        ...
			        foreach($noticias as $noticia){
			            ...
			            echo "<h3><a href='index.php?option=nuestrosClubes&verNoticia=".$noticia['id']."'>".$noticia['titulo']."</a></h3>";
			            echo "<h5>".$noticia['subtitulo']."</h5>";
			            //echo "<p> <img class='imagenNoticia' src='css/imagenes/noticias/".$noticia['imagen']."' /> ".$noticia['texto']."</p>";
			            echo "<p><a href='index.php?option=nuestrosClubes&verNoticia=".$noticia['id']."'> <img class='imagenNoticia' src='css/imagenes/noticias/".$noticia['imagen']."' /></a> ".$textoCortado."...</p>";
			            echo "<a class='leerMas' href='index.php?option=nuestrosClubes&verNoticia=".$noticia['id']."'>Leer más</a>";
			            echo "</div>";
			    ...
			    //paginador
				    ...
				    for($i=0; $i<$numPaginas;$i++){
				       echo '<a href="index.php?option=nuestrosClubes&pag='.($i+1).'">'.($i+1).'</a> | ';
				    } 
				    echo "</div>";
